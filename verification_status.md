...
| Z5 exact coverage scan (IV.2) | `IN_PROGRESS` at time of writing; see Part IV execution record below once complete | Exact (non-sampled) scan of all `5^13-1` assignments per base against simple-C16 hyperplanes mod 5. |
